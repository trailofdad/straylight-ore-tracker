...
"use strict";$(document).ready(function(){console.log("Amarr Victor");var o=$(".ore-log__wrapper"),e=$("#ore-log-container");$(".ore-log__close").click(function(){$(this).parent().parent().remove()}),$("#add-ore-type").click(function(){o.clone(!0).appendTo(e),$(".ore-log__close").click(function(){$(this).parent().parent().remove()})}),$("#submit-ore-log").click(function(){$("#submit-ore-log").prop("disabled",!0);var o=$(".ore-log"),e=$("#log-title").val(),t=$("#log-description").val(),r={};o.each(function(e){var t=o[e].firstElementChild.value,l=$(o[e]).find("input")[0].value,i={};i[t]=l,r[e]=i}),$.ajax({type:"POST",url:"http://straylight.systems/wp-json/sot/v1/logs/submit",data:{log_title:e,log_description:t,log_data:r,id:wp.id},success:function(){console.log("Log Submitted Successfully"),$(".ore-log__wrapper").remove(),$("#submit-ore-log").replaceWith('<h2 style="padding-top:5rem;">Thank you commander, your Ore Log has been submitted.</h2>')},error:function(){console.log("Something has gone terribly wrong with submitting the log")},dataType:"json"})})});
