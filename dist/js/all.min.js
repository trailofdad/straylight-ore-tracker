...
"use strict";$(document).ready(function(){function e(){var e=$(".ore-log__input");e.each(function(o){return!!e[o].validity.valid});var o=$("#log-title")[0],t=$("#log-description")[0];return!(!o.validity.valid||!t.validity.valid)}function o(){$("#submit-ore-log").prop("disabled",!0);var o=$(".ore-log"),t=$("#log-title").val(),i=$("#log-description").val(),r={};if(o.each(function(e){var t=o[e].firstElementChild.value,i=$(o[e]).find("input")[0].value,l={};l[t]=i,r[e]=l}),e())$.ajax({type:"POST",url:"http://straylight.dev/wp-json/sot/v1/logs/submit",data:{log_title:t,log_description:i,log_data:r,id:wp.id},success:function(){var e=$(".alert");e&&e.remove(),console.log("Log Submitted Successfully"),$(".ore-log__wrapper").remove(),$("#submit-ore-log").replaceWith('<h2 style="padding-top:5rem;">Thank you commander, your Ore Log has been submitted.</h2>')},error:function(){console.log("Something has gone terribly wrong with submitting the log")},dataType:"json"});else{var l=$(".alert");l&&l.remove();var n='<div class="alert alert-warning">\n                        <strong>Attention!</strong> Please ensure all fields have been filled out and are valid.\n                      </div>';$("#submit-container").prepend(n),$("#submit-ore-log").prop("disabled",!1)}}function t(){var e=$(".ore-log__wrapper"),t=$("#ore-log-container");$(".ore-log__close").click(function(){$(this).parent().parent().remove()}),$("#add-ore-type").click(function(){var o=e.clone(!0);o.children().children()[1].value="",o.appendTo(t)}),$("#submit-ore-log").click(function(){o()})}function i(){console.log("Amarr Victor"),t()}i()});
