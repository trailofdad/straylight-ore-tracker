...
"use strict";$(document).ready(function(){function e(){var e=$(".ore-log__input");e.each(function(o){if(!e[o].validity.valid)return alert("invalid field"),!1});var o=$("#log-title")[0],t=$("#log-description")[0];return!(!o.validity.valid||!t.validity.valid)||(alert("invalid title or description field"),!1)}function o(){$("#submit-ore-log").prop("disabled",!0);var o=$(".ore-log"),t=$("#log-title").val(),i=$("#log-description").val(),l={};o.each(function(e){var t=o[e].firstElementChild.value,i=$(o[e]).find("input")[0].value,r={};r[t]=i,l[e]=r}),e()?$.ajax({type:"POST",url:"http://straylight.dev/wp-json/sot/v1/logs/submit",data:{log_title:t,log_description:i,log_data:l,id:wp.id},success:function(){console.log("Log Submitted Successfully"),$(".ore-log__wrapper").remove(),$("#submit-ore-log").replaceWith('<h2 style="padding-top:5rem;">Thank you commander, your Ore Log has been submitted.</h2>')},error:function(){console.log("Something has gone terribly wrong with submitting the log")},dataType:"json"}):(alert("Please ensure you have filled out all fields"),$("#submit-ore-log").prop("disabled",!1))}function t(){var e=$(".ore-log__wrapper"),t=$("#ore-log-container");$(".ore-log__close").click(function(){$(this).parent().parent().remove()}),$("#add-ore-type").click(function(){e.clone(!0).appendTo(t),$(".ore-log__close").click(function(){$(this).parent().parent().remove()})}),$("#submit-ore-log").click(function(){o()})}function i(){console.log("Amarr Victor"),t()}i()});
