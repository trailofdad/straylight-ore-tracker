...
"use strict";$(document).ready(function(){function o(){var o=$(".ore-log__input");o.each(function(e){if(!o[e].validity.valid)return!1});var e=$("#log-title")[0],t=$("#log-description")[0];return!(!e.validity.valid||!t.validity.valid)}function e(){$("#submit-ore-log").prop("disabled",!0);var e=$(".ore-log"),t=$("#log-title").val(),i=$("#log-description").val(),l={};e.each(function(o){var t=e[o].firstElementChild.value,i=$(e[o]).find("input")[0].value,r={};r[t]=i,l[o]=r}),o()?$.ajax({type:"POST",url:"http://straylight.dev/wp-json/sot/v1/logs/submit",data:{log_title:t,log_description:i,log_data:l,id:wp.id},success:function(){console.log("Log Submitted Successfully"),$(".ore-log__wrapper").remove(),$("#submit-ore-log").replaceWith('<h2 style="padding-top:5rem;">Thank you commander, your Ore Log has been submitted.</h2>')},error:function(){console.log("Something has gone terribly wrong with submitting the log")},dataType:"json"}):(alert("Please ensure you have filled out all fields"),$("#submit-ore-log").prop("disabled",!1))}function t(){var o=$(".ore-log__wrapper"),t=$("#ore-log-container");$(".ore-log__close").click(function(){$(this).parent().parent().remove()}),$("#add-ore-type").click(function(){var e=o.clone(!0);e.children().children()[1].value="",e.appendTo(t)}),$("#submit-ore-log").click(function(){e()})}function i(){console.log("Amarr Victor"),t()}i()});
